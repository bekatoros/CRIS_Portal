...
<div class="container">
    ...
    <div class="row-fluid">
        ...
        <div class="span6"  >
            ...
            <form class="form-horizontal" method="post"  accept-charset="utf-8" action="<?php echo base_url() . 'index.php/fund/submit'; ?>">
                <div class="control-group">
                    <label class="control-label editable-input" for="fName_en" id="lbl_fName_en">Τίτλος (Αγγλικά)</label>
                    <div class="controls">
                        <input type="text" id="fName_en" placeholder="Αγγλικός Τίτλος" name="fName_en">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="fName_el" id="lbl_fName_el">Τίτλος (Ελληνικά)</label>
                    <div class="controls">
                        <input type="text" id="fName_el" placeholder="Ελληνικός Τίτλος" name="fName_el">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="fAmount" id="lbl_fAmount">Ποσό Χρηματοδότησης</label>
                    <div class="controls">
                        <input type="number" id="fAmount" placeholder="Ποσό" name="fAmount">
                    </div>
                </div>                
                <div class="control-group">
                    <label class="control-label" for="startDate">Ημερομηνία Εκκίνησης</label>
                    <div class="controls">
                        <input type="text" id="startDate" name="startDate" data-date-format="dd-mm-yyyy">
                    </div>
                </div>                
                <div class="control-group">
                    <label class="control-label" for="endDate">Ημερομηνία Τερματισμού</label>
                    <div class="controls">
