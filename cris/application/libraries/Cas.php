...
class Cas {
    ...
    public function __construct() {
     ...
     public function check_cas_user($user) {
        
        if (isset($user)) {          
                        $data['email'] = $user->attributes['mail'];
                        $data['name'] = $user->attributes['givenName'];
                        $data['surname'] = $user->attributes['sn'];
                        $data['title'] = $user->attributes['title'];
                        $data['department'] = $user->attributes['ou'];                     
